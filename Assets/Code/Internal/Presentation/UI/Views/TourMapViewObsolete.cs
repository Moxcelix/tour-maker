...
public class TourMapViewObsolete : MonoBehaviour
{
    ...
    private void OnNewPanorama(Panorama panorama, Texture texture)
    {
       ...
       // panoramaView.OnPanoramaClicked += OnPanoramaClicked;
        //panoramaView.OnPanoramaMoved += OnPanoramaMoved;

        panoramaViews.Add(panoramaView);

        OnPanoramaSelected(panorama.Id);
    }
    ...
    public void ClearAll()
    {
        ...
        {
           // view.OnPanoramaMoved -= OnPanoramaMoved;
            //view.OnPanoramaClicked -= OnPanoramaClicked;
    ...
    private void Update()
    {
        ...
        if (isLinking)
        {
            ...
            currentLineRenderer.UpdatePoints(new Vector2[] { pano.GetLocalPosition(), mousePos });
        ...
        {
            var pano1 = GetPanoramaView(bridge.Panorama1.Id);
            var pano2 = GetPanoramaView(bridge.Panorama2.Id);
